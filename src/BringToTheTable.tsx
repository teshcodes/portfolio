export default function BringToTheTable() {
  const skills = [
    ...
    { name: "Mobile App Developer", img: "/React2.svg" },
  ...
  return (
    <section id="skills" className="mt-12 md:mt-20">
      {/* Section Heading */}
      ...
      <div className="mt-10 flex flex-wrap justify-center gap-6 p-2 rounded-lg">
        {skills.map((skill, index) => (
          <div
            key={index}
            className="flex flex-col items-center text-center gap-2 border border-[#1C1C21] rounded-t-full rounded-b-full py-7 px-6 w-[140px] hover:bg-[#2D3240] transition"
          >
            <img
              src={skill.img}
              alt={skill.name}
